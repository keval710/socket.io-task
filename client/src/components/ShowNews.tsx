        ...
        <div>
            <section className="text-gray-800 body-font bg-slate-200">
                <div className="container px-3 py-24 mx-auto max-w-7x1">
                    <div className="flex flex-wrap justify-between w-full mb-4 p-4">
                        ...
                        <div>
                            <button
                                ...
                                className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 px-4 rounded-xl inline-flex items-center"
                            >
                    ...
                    {
                        showForm &&
                        <div id="info-popup" className={`bg-transparent overflow-y-auto overflow-x-hidden ${isMobile ? 'absolute' : 'fixed'} top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full`}>
                            {showForm && <AddNewsForm />}</div>
                    }
